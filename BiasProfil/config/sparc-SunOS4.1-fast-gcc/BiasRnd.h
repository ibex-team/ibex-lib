/************************************************************************
 *
 * Basic Interval Arithmetic Subroutines Sparc-Rounding (SunOS4.1, gcc)
 * --------------------------------------------------------------------
 *
...
extern const unsigned int _BiasCwRoundUp;
extern const unsigned int _BiasCwRoundDown;
extern const unsigned int _BiasCwRoundNear;
