...
public:
	...
	/** the default precision on the objective, set to 1e-9. */
	 ...
	 * 
	 * Create the statistics structure for this LP solver add it
	 * into \c s, and enable statistics. This may slightly affect 
	 * performances.
	 */
	 void enable_statistics(Statistics& s, const std::string& prefix);
...
private:
	...
	/* Statistics (null if statistics are disabled). 
	 * Deletion is ensured by Statistics. */
	StsLPSolver* statistics;
