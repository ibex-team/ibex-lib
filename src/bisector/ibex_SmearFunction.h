...
public:
	 ...
	 */
	SmearFunction(System& sys, double w, double ratio=Bsc::default_ratio) :
...
public :
	 ...
	 *  bisected interval. Default value is 0.45
	 */
	SmearMax (System& sys,  double w, double ratio=Bsc::default_ratio)
...
public :
	 ...
	 *  bisected interval. Default value is 0.45
	 */
	SmearSum (System& sys, double  w, double ratio=Bsc::default_ratio)
	: SmearFunction (sys,w,ratio) {;};
...
public :
	 ...
	 *  bisected interval. Default value is 0.45
	 */
	SmearSumRelative (System& sys,  double w, double ratio=Bsc::default_ratio)
	: SmearFunction (sys,w,ratio) { }
...
public :
	 ...
	 *  bisected interval. Default value is 0.45
	 */
	SmearMaxRelative (System& sys,  double w, double ratio=Bsc::default_ratio)
	: SmearFunction (sys,w,ratio) { }
