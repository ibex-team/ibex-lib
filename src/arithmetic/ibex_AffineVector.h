...
template<class T> inline bool is_empty(const AffineMain<T>& x)       { return x.is_empty(); }
template<class T> inline bool is_empty(const AffineMainVector<T>& v) { return v.is_empty(); }
//template<class T> inline bool is_empty(const AffineMainMatrix<T>& m) { return m.is_empty(); }
...
template<class T> inline void set_empty(AffineMain<T>& x)       { x.set_empty(); }
template<class T> inline void set_empty(AffineMainVector<T>& v) { v.set_empty(); }
//template<class T> inline void set_empty(AffineMainMatrix<T>& m) { m.set_empty(); }
