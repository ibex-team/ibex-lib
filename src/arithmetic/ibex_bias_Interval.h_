...
inline bool proj_pow(const Interval& y, Interval& x1, Interval& x2) {
	cerr << "warning: proj_power(y,x1,x2) (with x1 and x2 intervals) not implemented yet with BIAS" << endl;
	return true;
}
...
inline bool proj_atan2(const Interval& y, Interval& x1, Interval& x2) {
	cerr << "warning: proj_atan2 non implemented yet with Profil/Bias";
	return true;
}
