...
public:
	...
	Affine2Matrix(int nb_rows, int nb_cols, const Interval& x);
	 ...
	 * the [i][j] component initialized to \a Affine2(x.nb_col*x.nb_row, j+i*nb_row+1,x[i][j]).
	 */
	Affine2Matrix(const IntervalMatrix& m);
...
bool proj_add(const Affine2Matrix& y, IntervalMatrix& x1, Affine2Matrix& x2);
bool proj_add(const Affine2Matrix& y, Affine2Matrix& x1, IntervalMatrix& x2);
bool proj_add(const IntervalMatrix& y,IntervalMatrix& x1, Affine2Matrix& x2);
bool proj_add(const Affine2Matrix& y, IntervalMatrix& x1, IntervalMatrix& x2);
...
bool proj_sub(const Affine2Matrix& y, IntervalMatrix& x1, IntervalMatrix& x2);
...
bool proj_mul(const Affine2Matrix& y, Interval& x1, Affine2Matrix& x2);
bool proj_mul(const Affine2Matrix& y, Affine2& x1, IntervalMatrix& x2);
bool proj_mul(const IntervalMatrix& y,Interval& x1, Affine2Matrix& x2);
bool proj_mul(const Affine2Matrix& y, Interval& x1, IntervalMatrix& x2);
...
bool proj_mul(const Affine2Vector& y, IntervalMatrix& x1, Affine2Vector& x2, double ratio);
bool proj_mul(const Affine2Vector& y, Affine2Matrix& x1, IntervalVector& x2, double ratio);
bool proj_mul(const IntervalVector& y,IntervalMatrix& x1, Affine2Vector& x2, double ratio);
bool proj_mul(const Affine2Vector& y, IntervalMatrix& x1, IntervalVector& x2, double ratio);
...
bool proj_mul(const Affine2Vector& y, IntervalVector& x1, Affine2Matrix& x2, double ratio);
bool proj_mul(const Affine2Vector& y, Affine2Vector& x1, IntervalMatrix& x2, double ratio);
bool proj_mul(const IntervalVector& y,IntervalVector& x1, Affine2Matrix& x2, double ratio);
bool proj_mul(const Affine2Vector& y, IntervalVector& x1, IntervalMatrix& x2, double ratio);
...
bool proj_mul(const Affine2Matrix& y, IntervalMatrix& x1, Affine2Matrix& x2, double ratio);
bool proj_mul(const Affine2Matrix& y, Affine2Matrix& x1, IntervalMatrix& x2, double ratio);
bool proj_mul(const IntervalMatrix& y,IntervalMatrix& x1, Affine2Matrix& x2, double ratio);
bool proj_mul(const Affine2Matrix& y, IntervalMatrix& x1, IntervalMatrix& x2, double ratio);
...
inline bool proj_add(const Affine2Matrix& y, IntervalMatrix& x1, Affine2Matrix& x2){
 	 return proj_add(y.itv(),x2,x1);
}
inline bool proj_add(const Affine2Matrix& y, Affine2Matrix& x1, IntervalMatrix& x2){
 	 return proj_add(y.itv(),x1,x2);
}
inline bool proj_add(const IntervalMatrix& y,IntervalMatrix& x1, Affine2Matrix& x2){
 	 return proj_add(y,x2,x1);
}
inline bool proj_add(const Affine2Matrix& y, IntervalMatrix& x1, IntervalMatrix& x2){
 	 return proj_add(y.itv(),x1,x2);
}
...
inline bool proj_mul(const Affine2Matrix& y, Affine2& x1, Affine2Matrix& x2){
 	 return proj_mul(y.itv(),x1,x2);
}
inline bool proj_mul(const Affine2Matrix& y, Interval& x1, Affine2Matrix& x2){
 	 return proj_mul(y.itv(),x1,x2);
}
inline bool proj_mul(const Affine2Matrix& y, Affine2& x1, IntervalMatrix& x2){
 	 return proj_mul(y.itv(),x1,x2);
}
inline bool proj_mul(const Affine2Matrix& y, Interval& x1, IntervalMatrix& x2){
 	 return proj_mul(y.itv(),x1,x2);
}



inline bool proj_mul(const Affine2Vector& y, Affine2Matrix& x1, Affine2Vector& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Vector& y, IntervalMatrix& x1, Affine2Vector& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Vector& y, Affine2Matrix& x1, IntervalVector& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Vector& y, IntervalMatrix& x1, IntervalVector& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}


inline bool proj_mul(const Affine2Vector& y, Affine2Vector& x1, Affine2Matrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Vector& y, IntervalVector& x1, Affine2Matrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Vector& y, Affine2Vector& x1, IntervalMatrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Vector& y, IntervalVector& x1, IntervalMatrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}


inline bool proj_mul(const Affine2Matrix& y, Affine2Matrix& x1, Affine2Matrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Matrix& y, IntervalMatrix& x1, Affine2Matrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Matrix& y, Affine2Matrix& x1, IntervalMatrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
inline bool proj_mul(const Affine2Matrix& y, IntervalMatrix& x1, IntervalMatrix& x2, double ratio){
 	 return proj_mul(y.itv(),x1,x2,ratio);
}
