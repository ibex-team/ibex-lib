...
public: // because called from CompiledFunction
	...
	inline void symbol_bwd (int y)                  { /* nothing to do */ }
	inline void cst_bwd    (int y)                  { /* TODO: improve this. */ if (d[y]!=((const ExprConstant&) f.nodes[y]).get()) throw EmptyBoxException(); }
	inline void index_bwd  (int x, int y)           { /* nothing to do */ }
	       void vector_bwd (int* x, int y)          { not_implemented("Inner projection of \"vector\""); }
	inline void apply_bwd  (int* x, int y);
	inline void chi_bwd    (int a,int b,int c,int y){ not_implemented("Inner projection of \"chi\""); }
	inline void add_bwd    (int x1, int x2, int y)  { if (!ibwd_add(d[y].i(),d[x1].i(),d[x2].i(),p[x1].i(),p[x2].i())) throw EmptyBoxException(); }
	inline void add_V_bwd  (int x1, int x2, int y)  { not_implemented("Inner projection of \"add_V\""); }
	inline void add_M_bwd  (int x1, int x2, int y)  { not_implemented("Inner projection of \"add_M\""); }
	inline void mul_bwd    (int x1, int x2, int y)   { if (!ibwd_mul(d[y].i(),d[x1].i(),d[x2].i(),p[x1].i(),p[x2].i())) throw EmptyBoxException(); }
	inline void mul_SV_bwd (int x1, int x2, int y)  { not_implemented("Inner projection of \"mul_SV\""); }
	inline void mul_SM_bwd (int x1, int x2, int y)  { not_implemented("Inner projection of \"mul_SM\""); }
	inline void mul_VV_bwd (int x1, int x2, int y)  { not_implemented("Inner projection of \"mul_VV\""); }
	inline void mul_MV_bwd (int x1, int x2, int y)  { not_implemented("Inner projection of \"mul_MV\""); }
	inline void mul_VM_bwd (int x1, int x2, int y)  { not_implemented("Inner projection of \"mul_VM\""); }
	inline void mul_MM_bwd (int x1, int x2, int y)  { not_implemented("Inner projection of \"mul_MM\""); }
	inline void sub_bwd    (int x1, int x2, int y)  { if (!ibwd_sub(d[y].i(),d[x1].i(),d[x2].i(),p[x1].i(),p[x2].i())) throw EmptyBoxException(); }
	inline void sub_V_bwd  (int x1, int x2, int y)  { not_implemented("Inner projection of \"sub_V\""); }
	inline void sub_M_bwd  (int x1, int x2, int y)  { not_implemented("Inner projection of \"sub_M\""); }
	...
	inline void atan2_bwd  (int x1, int x2, int y)  { not_implemented("Inner projection of \"atan2\""); }
	inline void minus_bwd  (int x, int y)           { if (!ibwd_minus(d[y].i(),d[x].i())) throw EmptyBoxException(); }
    inline void trans_V_bwd(int x, int y)           { not_implemented("Inner projection of \"transpose\""); }
    inline void trans_M_bwd(int x, int y)           { not_implemented("Inner projection of \"transpose\""); }
	inline void sign_bwd   (int x, int y)           { not_implemented("Inner projection of \"sign\""); }
	...
	inline void cosh_bwd   (int x, int y)           { not_implemented("Inner projection of \"cosh\""); }
	inline void sinh_bwd   (int x, int y)           { not_implemented("Inner projection of \"sinh\""); }
	inline void tanh_bwd   (int x, int y)           { not_implemented("Inner projection of \"tanh\""); }
	inline void acos_bwd   (int x, int y)           { not_implemented("Inner projection of \"acos\""); }
	inline void asin_bwd   (int x, int y)           { not_implemented("Inner projection of \"asin\""); }
	inline void atan_bwd   (int x, int y)           { not_implemented("Inner projection of \"atan\""); }
	inline void acosh_bwd  (int x, int y)           { not_implemented("Inner projection of \"acosh\""); }
	inline void asinh_bwd  (int x, int y)           { not_implemented("Inner projection of \"asinh\""); }
	inline void atanh_bwd  (int x, int y)           { not_implemented("Inner projection of \"atanh\""); }
};
