...
//	       void vector_bwd(const ExprVector&,  ExprLabel** compL, const ExprLabel& result)       { not_implemented("Inner projection of \"vector\""); }
	...
	inline void minus_bwd (const ExprMinus& , ExprLabel& x, const ExprLabel& y)                 { if (!iproj_minus(y.d->i(),x.d->i())) throw EmptyBoxException(); }
	...
	inline void abs_bwd   (const ExprAbs& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_abs(y.d->i(),x.d->i())) throw EmptyBoxException(); }
	...
	inline void sqr_bwd   (const ExprSqr& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_sqr(y.d->i(),x.d->i(),x.p->i())) throw EmptyBoxException(); }
	inline void sqrt_bwd  (const ExprSqrt& ,  ExprLabel& x, const ExprLabel& y)                 { if (!iproj_sqrt(y.d->i(),x.d->i())) throw EmptyBoxException(); }
	inline void exp_bwd   (const ExprExp& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_exp(y.d->i(),x.d->i())) throw EmptyBoxException(); }
	inline void log_bwd   (const ExprLog& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_log(y.d->i(),x.d->i())) throw EmptyBoxException(); }
	inline void cos_bwd   (const ExprCos& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_cos(y.d->i(),x.d->i(),x.p->i())) throw EmptyBoxException(); }
	inline void sin_bwd   (const ExprSin& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_sin(y.d->i(),x.d->i(),x.p->i())) throw EmptyBoxException();}
	inline void tan_bwd   (const ExprTan& ,   ExprLabel& x, const ExprLabel& y)                 { if (!iproj_tan(y.d->i(),x.d->i(),x.p->i())) throw EmptyBoxException(); }
