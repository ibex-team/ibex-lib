...
NumConstraint::NumConstraint(const char* filename) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_system(System(filename));
}

NumConstraint::NumConstraint(const char* x, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x1,x2),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* x3, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x1,x2,x3),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* x3, const char* x4, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x1,x2,x3,x4),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* x3, const char* x4, const char* x5, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x1,x2,x3,x4,x5),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* x3, const char* x4, const char* x5, const char* x6, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x1,x2,x3,x4,x5,x6),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* x3, const char* x4, const char* x5, const char* x6, const char* x7, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
	build_from_string(Array<const char*>(x1,x2,x3,x4,x5,x6,x7),c);
}

NumConstraint::NumConstraint(const char* x1, const char* x2, const char* x3, const char* x4, const char* x5, const char* x6, const char* x7, const char* x8, const char* c) : f(*new Function()), op(EQ), own_f(true), active_prop_id(next_id()) {
