...
public:
	 ...
	 * \brief Initialize symbols affine domains from d
	 */
	void write_arg_af3_domains(const Array<Affine3Domain>& d) const;

	/**
	 * \brief Initialize symbols affine domains from d
	 */
	void write_arg_af3_domains(const Array<const Affine3Domain>& d) const;

	/**
	 * \brief Initialize symbols affine domains from a box
	 */
	void write_arg_af3_domains(const IntervalVector& box) const;

	/**
	 * \brief Initialize symbols affine domains from a box
	 */
	void write_arg_af3_domains(const Affine3Vector& box) const;
