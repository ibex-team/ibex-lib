...
public:
	 ...
	 * \param record  - (for cleanup). All nodes created. Some may not
	 *                  appear in the final expression thanks to simplification.
	 */
	Expr2Polynom(std::vector<const ExprNode*>& record, bool develop=false);
