...
class ResetVisited : public ExprVisitor {
public:
	ResetVisited(const ExprNode& e)   { visit(e); }
protected:
	void visit(const ExprNode& e)     { e.deco.visited=false; e.deco.tmp=NULL; e.acceptVisitor(*this); }
...
class SizeofDAG : public ExprVisitor {
public:
...
class ExprSubNodes : public ExprVisitor {
