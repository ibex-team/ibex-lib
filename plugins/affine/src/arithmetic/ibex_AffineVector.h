...
public:
	 ...
	 * all the components initialized to Affine(\a n,i+1,\a x) }.
	 * \pre n>0
	 */
	 ...
	 * AffineMain(\a n, i+1,Interval(bounds[i][0],bounds[i][1]) )
	...
	/**
	 * \brief Set all the elements to Affine(n,i+1,x)
	 *
	 * \note Emptiness is "overridden".
	 */
