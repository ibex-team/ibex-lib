...
template<class T>
class TestAffineArith2 : public CppUnit::TestFixture {
public:
	CPPUNIT_TEST_SUITE(TestAffineArith2<T>);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_Default>);
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_Other>);



#ifdef _IBEX_WITH_AFFINE_EXTENDED_

CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_fAF2>);
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_fAFFullI>);
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_iAF>);
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_fAF1>);
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_No>);
CPPUNIT_TEST_SUITE_REGISTRATION(TestAffineArith2<AF_sAF>);
