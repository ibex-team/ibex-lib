...
template<class T>
void TestAffineArith2<T>::test01() {
	Variable x(2);
...
template<class T>
void TestAffineArith2<T>::test02() {
	Variable x;
...
template<class T>
void TestAffineArith2<T>::test_pow2() {
	Variable x;
	Interval itv;
...
template<class T>
void TestAffineArith2<T>::test_pow4() {
	Variable x;
	Interval itv;
...
template<class T>
void TestAffineArith2<T>::test_pow5() {
	Variable x;
	Interval itv;
...
template<class T>
void TestAffineArith2<T>::test_powINT1() {
	Variable x;
	Interval itv;
...
template<class T>
void TestAffineArith2<T>::test_powINT2() {
	Variable x;
	Interval itv;
	Function f(x,pow(x,Interval(-2,3)));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_sqrt() {
	Variable x;
	Interval itv;
	Function f(x,sqrt(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_exp() {
	Variable x;
	Interval itv;
	Function f(x,exp(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_log() {
	Variable x;
	Interval itv;
	Function f(x,log(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_inv() {
	Variable x;
	Interval itv;
	Function f(x,1.0/x);
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_cos() {
	Variable x;
	Interval itv;
	Function f(x,cos(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_sin() {
	Variable x;
	Interval itv;
	Function f(x,sin(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_tan() {
	Variable x;
	Interval itv;
	Function f(x,tan(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_abs() {
	Variable x;
	Interval itv;
	Function f(x,abs(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_acos() {
	Variable x;
	Interval itv;
	Function f(x,acos(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_asin() {
	Variable x;
	Interval itv;
	Function f(x,asin(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_atan() {
	Variable x;
	Interval itv;
	Function f(x,atan(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_cosh() {
	Variable x;
	Interval itv;
	Function f(x,cosh(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_sinh() {
	Variable x;
	Interval itv;
	Function f(x,sinh(x));
	itv =Interval(1,2);
...
template<class T>
void TestAffineArith2<T>::test_tanh() {
	Variable x;
	Interval itv;
	Function f(x,tanh(x));
	itv =Interval(1,2);
...
template<class T>
bool TestAffineArith2<T>::check_af2 (Function& f, IntervalVector& I){
	return check_af2(f,I[0]);
}

template<class T>
bool TestAffineArith2<T>::check_af2 (Function& f, Interval& I){
