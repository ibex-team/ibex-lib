...
#ifndef __IBEX_CELL_HEAPGEN_H__
#define __IBEX_CELL_HEAPGEN_H__
 ...
 */
class CellHeapGen : public CellBuffer {
 ...
 protected:
  ...
  friend std::ostream& operator<<(std::ostream&, const CellHeapGen&);


};

/** Display the buffer */
std::ostream& operator<<(std::ostream&, const CellHeapGen&);

} // end namespace ibex
#endif // __IBEX_CELL_HEAPGEN_H__
