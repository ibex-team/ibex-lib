	...
	*/
	...
	for (int i=0; i<p; i++) {
	  ...
	  */
	  ...
	  m_fun[0][i]= new Function (w, sqr(linfun[i][0][0] * w[8]+ linfun[i][1][0] * w[0] + 
					  linfun[i][2][0] * w[1]+	linfun[i][3][0] * w[2]  +
					  linfun[i][4][0] * w[3]+	linfun[i][5][0] * w[4]  +
					  linfun[i][6][0] * w[5]+	linfun[i][7][0] * w[6]  +
					  linfun[i][8][0] * w[7])
				   /
				   (sqr (w[0]* linfun1[i][0] +w[1] * linfun1[i][2] + w[2]*linfun1[i][8])
				    +sqr(w[3] * linfun1[i][4] + w[4] * linfun1[i][6] + w[5]*linfun1[i][9])
				    + sqr(w[0]* linfun1[i][1] + w[3] *  linfun1[i][3] + w[6]*linfun1[i][8])
				    +sqr (w[1]* linfun1[i][5] + w[4] *  linfun1[i][7] + w[7]*linfun1[i][9])
				    )
				   -Interval(0,epseq));
