...
const double epseq=0.001/256;                                        // epsilon on plane constraint
...
int main(int argc, char** argv) {
	...
	for (int i=0;i<NP;i++)
	  z->push_back((double)(rand()%256)/256);
        if (pb <=3)
	  { int kk;
	    ...
	    for (int i=0;i<kk;i++)
	      {	
		y->push_back((double)(rand()%256)/256);
		y->push_back((double)(rand()%256)/256);
		y->push_back((double)(rand()%256)/256);
		y->push_back((22 + (((double)rand()/(double)RAND_MAX)*0.001))/256);
		y->push_back((12 + (((double)rand()/(double)RAND_MAX)*0.001))/256);
	      }
	    ...
	    int kk1 = NP/10;
	    for (int i=0;i<kk1;i++)
	      {x->push_back((10+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
		if (pb==1)
		  x->push_back((10 + (((double)rand()/(double)RAND_MAX)*0.001))/256);
		else
		  x->push_back((double)(rand()%256)/256);
		x->push_back((100 + (((double)rand()/(double)RAND_MAX)*0.001))/256);
		x->push_back((double)(rand()%256)/256);
		x->push_back((double)(rand()%256)/256);
		x->push_back((double)(rand()%256)/256);
		x->push_back((double)(rand()%256)/256);
	  ...
	  for (int i=0;i<NP;i++)
	    ...
	    for (int i=0;i<Qi;i++)  {
	      ...
	      x->push_back((300- y->at(65*i) - z-> at(65*i)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	      x->push_back((- y->at(65*i+1)  + z-> at(65*i+1)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	      x->push_back((-200+ y->at(65*i+2)  + z-> at(65*i+2)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	      x->push_back(( y->at(65*i+3)  - z-> at(65*i+3)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	      x->push_back((320- y->at(65*i+4) - z-> at(65*i+4)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	      x->push_back((10 - y->at(65*i+5)  + z-> at(65*i+5)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	      x->push_back((5- y->at(65*i+6)  + z-> at(65*i+6)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((15- y->at(65*i+7)  + z-> at(65*i+7)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((330- y->at(65*i+8) - z-> at(65*i+8)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((20- y->at(65*i+9)  + z-> at(65*i+9)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((-210+ y->at(65*i+10)  + z-> at(65*i+10)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((25 -y->at(65*i+11)  - z-> at(65*i+11)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((340- y->at(65*i+12) - z-> at(65*i+12)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((30 - y->at(65*i+13)  + z-> at(65*i+13)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((35- y->at(65*i+14)  + z-> at(65*i+14)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((40- y->at(65*i+15)  + z-> at(65*i+15)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);

	     x->push_back((350- y->at(65*i+16) - z-> at(65*i+16)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((3- y->at(65*i+17)  + z-> at(65*i+17)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((-220+ y->at(65*i+18)  + z-> at(65*i+18)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back(( 12 + y->at(65*i+19)  - z-> at(65*i+19)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((360- y->at(65*i+20) - z-> at(65*i+20)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((12 - y->at(65*i+21)  + z-> at(65*i+21)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((7- y->at(65*i+22)  + z-> at(65*i+22)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((17- y->at(65*i+23)  + z-> at(65*i+23)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((370- y->at(65*i+24) - z-> at(65*i+24)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    for (int j=0; j<40; j++)  x->push_back((double)(rand()%256)/256);
	    }
	    int K0=NP-Qi*65; 
	    cout << K0 << endl;
	    for (int i=0; i< K0;i++) x->push_back((double)(rand()%256)/256);
	  }
	  else
	...
	for (int i=0;i< Qi;i++)
	  {
	    int nn= 50;
	    x->push_back((300- y->at(nn*i) - z-> at(nn*i)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((- y->at(nn*i+1)  + z-> at(nn*i+1)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((-200+ y->at(nn*i+2)  + z-> at(nn*i+2)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back(( y->at(nn*i+3)  - z-> at(nn*i+3)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((320- y->at(nn*i+4) - z-> at(nn*i+4)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((10 - y->at(nn*i+5)  + z-> at(nn*i+5)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((5- y->at(nn*i+6)  + z-> at(nn*i+6)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((15- y->at(nn*i+7)  + z-> at(nn*i+7)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((330- y->at(nn*i+8) - z-> at(nn*i+8)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((20- y->at(nn*i+9)  + z-> at(nn*i+9)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((-210+ y->at(nn*i+10)  + z-> at(nn*i+10)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((25 -y->at(nn*i+11)  - z-> at(nn*i+11)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((340- y->at(nn*i+12) - z-> at(nn*i+12)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((30 - y->at(nn*i+13)  + z-> at(nn*i+13)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((35- y->at(nn*i+14)  + z-> at(nn*i+14)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((40- y->at(nn*i+15)  + z-> at(nn*i+15)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);

	     x->push_back((350- y->at(nn*i+16) - z-> at(nn*i+16)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((3- y->at(nn*i+17)  + z-> at(nn*i+17)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((-220+ y->at(nn*i+18)  + z-> at(nn*i+18)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back(( 12 + y->at(nn*i+19)  - z-> at(nn*i+19)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);	
	    x->push_back((360- y->at(nn*i+20) - z-> at(nn*i+20)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((12 - y->at(nn*i+21)  + z-> at(nn*i+21)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((7- y->at(nn*i+22)  + z-> at(nn*i+22)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((17- y->at(nn*i+23)  + z-> at(nn*i+23)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    x->push_back((370- y->at(nn*i+24) - z-> at(nn*i+24)+ (((double)rand()/(double)RAND_MAX)*0.001))/256);
	    int K1=25;
	    //	    K1=0;
	    for (int j=0; j< K1;j++) x->push_back(((double)(rand()%256))/256);
	  }
	
	  if (pb==6)	for (int j=0; j< NP/2;j++) x->push_back(((double)(rand()%256))/256);
	}
