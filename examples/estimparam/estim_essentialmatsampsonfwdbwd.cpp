...
;
	...
	*/
	...
	for (int i=0; i<p; i++) {
	  ...
	  m_func[i]= new Function (v, sqr(linfun[i][0][0] * v[2][2]+ linfun[i][1][0] * v[0][0] + 
...
//{1.41078e-05, 3.03704e-05, -0.0470103 ,-0.000295304, -2.03532e-06, 0.672895, 0.133288, -0.599274,-9.03183};
	...
	for (int i=0; i< 9; i++)
	  {_box[i][0]= fundmat[i] - 0.00000001;
	    _box[i][1]= fundmat[i]+ 0.00000001;
	  }
