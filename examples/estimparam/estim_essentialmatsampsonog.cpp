...
Interval matrixtrace (IntervalMatrix& M){
 ...
 int main(int argc, char** argv) {
   ...
   vector<double> x2;
	...
	Function fessential1 (v, v[0]*(sqr(v[0])+sqr(v[1])+sqr(v[2]) + sqr(v[3])  + sqr(v[6]) -( sqr(v[4])+sqr(v[5])+ sqr(v[7])+sqr(v[8]))) + 2* (v[3]*v[1]*v[4] + v[3]*v[2]*v[5]  + v[1]*v[6]*v[7] + v[2]*v[6]*v[8]) + eps2);
	Function fessential2(v, v[1]*(sqr(v[0])+sqr(v[1])+sqr(v[2]) + sqr(v[4])+sqr(v[7]) - (sqr(v[3]) + sqr(v[5])+ sqr(v[6])+ sqr(v[8]))) + 2*(v[0]*v[3]*v[4] + v[4]*v[2]*v[5] + v[0]*v[6]*v[7] + v[2]*v[7]*v[8])+eps2);
	Function fessential3(v, v[2]*(sqr(v[0])+sqr(v[1])+sqr(v[2]) + sqr(v[5])+sqr(v[8]) -( sqr(v[3]) + sqr(v[4]) + sqr(v[6])+ sqr(v[7]))) + 2*(v[0]*v[3]*v[5] + v[1]*v[4]*v[5]+ v[0]*v[6]*v[8] + v[1]*v[7]*v[8])+eps2);
	Function fessential4(v, v[3]*(sqr(v[0])+sqr(v[3])+sqr(v[4])+sqr(v[5]) + sqr(v[6]) - (sqr(v[1])+sqr(v[2]) + sqr(v[7])+sqr(v[8]))) + 2*(v[0]*v[1]*v[4] + v[0]*v[2]*v[5] + v[6]*v[4]*v[7] + v[5]*v[6]*v[8])+ eps2)
;
	Function fessential5(v, v[4]*(sqr(v[1])+sqr(v[3])+sqr(v[4])+sqr(v[5]) + sqr(v[7]) - (sqr(v[0])+ sqr(v[2]) + sqr(v[6])+sqr(v[8]))) + 2*( v[0]*v[1]*v[3] + v[1]*v[2]*v[5]+ v[3]*v[6]*v[7] + v[5]*v[7]*v[8])+ eps2);
	Function fessential6(v, v[5]*(sqr(v[2])+sqr(v[3])+sqr(v[4])+sqr(v[5]) + sqr(v[8])- (sqr(v[0])+ sqr(v[1])+  sqr(v[6])+sqr(v[7]))) + 2*(v[0]*v[2]*v[3] + v[1]*v[2]*v[4] + v[3]*v[6]*v[8]+ v[4]*v[7]*v[8])+eps2);
	Function fessential7(v, v[6]*( sqr(v[0])+sqr(v[3])+ sqr(v[6])+sqr(v[7])+sqr(v[8])- (sqr(v[1])+sqr(v[2])+  sqr(v[4])+sqr(v[5]))) + 2*(v[0]*v[1]*v[7] + v[0]*v[2]*v[8] + v[3]*v[4]*v[7] + v[3]*v[5]*v[8])+eps2);
	Function fessential8(v, v[7]*(sqr(v[1])+sqr(v[4])+ sqr(v[6])+sqr(v[7])+sqr(v[8])- (sqr(v[0])+ sqr(v[2]) +sqr(v[3])+sqr(v[5])) ) + 2*(v[0]*v[1]*v[6] + v[1]*v[2]*v[8] + v[3]*v[4]*v[6] + v[4]*v[5]*v[8])+ eps2);
	Function fessential9(v, v[8]*(sqr(v[2])+sqr(v[5]) + sqr(v[6])+sqr(v[7])+sqr(v[8])-(sqr(v[0])+sqr(v[1])+sqr(v[3])+sqr(v[4]))) + 2 * (v[0]*v[2]*v[6]+ v[1]*v[2]*v[7] + v[3]*v[5]*v[6] + v[4]*v[5]*v[7])+eps2);

	Function fessential11 (v, v[0]*(sqr(v[0])+sqr(v[1])+sqr(v[2]) + sqr(v[3])  + sqr(v[6]) -( sqr(v[4])+sqr(v[5])+ sqr(v[7])+sqr(v[8]))) + 2* (v[3]*v[1]*v[4] + v[3]*v[2]*v[5]  + v[1]*v[6]*v[7] + v[2]*v[6]*v[8]));
	Function fessential12(v, v[1]*(sqr(v[0])+sqr(v[1])+sqr(v[2]) + sqr(v[4])+sqr(v[7]) - (sqr(v[3]) + sqr(v[5])+ sqr(v[6])+ sqr(v[8]))) + 2*(v[0]*v[3]*v[4] + v[4]*v[2]*v[5] + v[0]*v[6]*v[7] + v[2]*v[7]*v[8]));
	Function fessential13(v, v[2]*(sqr(v[0])+sqr(v[1])+sqr(v[2]) + sqr(v[5])+sqr(v[8]) -( sqr(v[3]) + sqr(v[4]) + sqr(v[6])+ sqr(v[7]))) + 2*(v[0]*v[3]*v[5] + v[1]*v[4]*v[5]+ v[0]*v[6]*v[8] + v[1]*v[7]*v[8]));
	Function fessential14(v, v[3]*(sqr(v[0])+sqr(v[3])+sqr(v[4])+sqr(v[5]) + sqr(v[6]) - (sqr(v[1])+sqr(v[2]) + sqr(v[7])+sqr(v[8]))) + 2*(v[0]*v[1]*v[4] + v[0]*v[2]*v[5] + v[6]*v[4]*v[7] + v[5]*v[6]*v[8]));
	Function fessential15(v, v[4]*(sqr(v[1])+sqr(v[3])+sqr(v[4])+sqr(v[5]) + sqr(v[7]) - (sqr(v[0])+ sqr(v[2]) + sqr(v[6])+sqr(v[8]))) + 2*( v[0]*v[1]*v[3] + v[1]*v[2]*v[5]+ v[3]*v[6]*v[7] + v[5]*v[7]*v[8]));
	Function fessential16(v, v[5]*(sqr(v[2])+sqr(v[3])+sqr(v[4])+sqr(v[5]) + sqr(v[8])- (sqr(v[0])+ sqr(v[1])+  sqr(v[6])+sqr(v[7]))) + 2*(v[0]*v[2]*v[3] + v[1]*v[2]*v[4] + v[3]*v[6]*v[8]+ v[4]*v[7]*v[8]));
	Function fessential17(v, v[6]*( sqr(v[0])+sqr(v[3])+ sqr(v[6])+sqr(v[7])+sqr(v[8])- (sqr(v[1])+sqr(v[2])+  sqr(v[4])+sqr(v[5]))) + 2*(v[0]*v[1]*v[7] + v[0]*v[2]*v[8] + v[3]*v[4]*v[7] + v[3]*v[5]*v[8]));
	Function fessential18(v, v[7]*(sqr(v[1])+sqr(v[4])+ sqr(v[6])+sqr(v[7])+sqr(v[8])- (sqr(v[0])+ sqr(v[2]) +sqr(v[3])+sqr(v[5])) ) + 2*(v[0]*v[1]*v[6] + v[1]*v[2]*v[8] + v[3]*v[4]*v[6] + v[4]*v[5]*v[8]));
	Function fessential19(v, v[8]*(sqr(v[2])+sqr(v[5]) + sqr(v[6])+sqr(v[7])+sqr(v[8])-(sqr(v[0])+sqr(v[1])+sqr(v[3])+sqr(v[4]))) + 2 * (v[0]*v[2]*v[6]+ v[1]*v[2]*v[7] + v[3]*v[5]*v[6] + v[4]*v[5]*v[7]));
	...
	*/
	...
	Ctc* cdet;
        ...
        Function* m_norm = new Function (v, sqr(v[0])+sqr(v[1])+sqr(v[2])+ sqr(v[3]) + sqr(v[4]) + sqr(v[5]) + sqr(v[6]) + sqr(v[7])+sqr(v[8]) -1 + eps2);
	Function* m_norm1 = new Function (v, sqr(v[0])+sqr(v[1])+sqr(v[2])+ sqr(v[3]) + sqr(v[4]) + sqr(v[5]) + sqr(v[6]) + sqr(v[7])+sqr(v[8]) -1 );

	ctcnorm = new CtcFwdBwd(*m_norm);
	
	//	m_det = new Function (v, v[0]*(v[4]-v[7]*v[5]) - v[3]*(v[1] - v[2]*v[7] ) + v[6]*(v[1]*v[5]-v[2]*v[4]));
	m_det = new Function (v, v[0]*(v[4]*v[8]-v[7]*v[5]) - v[3]*(v[1]*v[8] - v[2]*v[7] ) + v[6]*(v[1]*v[5]-v[2]*v[4]) + eps2 );
	m_det1 = new Function (v, v[0]*(v[4]*v[8]-v[7]*v[5]) - v[3]*(v[1]*v[8] - v[2]*v[7] ) + v[6]*(v[1]*v[5]-v[2]*v[4]) );
	...
	Function m_essential1(w, m_essential(w) + eps);
...
linfun[i][0][0]=1;
	  ...
	  m_func[i]= new Function (v, (v[0]* (x1.at(i) * x2.at(i)) +
				       ...
				       v[8]+Interval(-epseq,epseq)));
	  */

	  m_func[i]= new Function (v, sqr(linfun[i][0][0] * v[8]+ linfun[i][1][0] * v[0] + 
					  linfun[i][2][0] * v[1]+	linfun[i][3][0] * v[2]  +
					  linfun[i][4][0] * v[3]+	linfun[i][5][0] * v[4]  +
					  linfun[i][6][0] * v[5]+	linfun[i][7][0] * v[6]  +
					  linfun[i][8][0] * v[7])
				   /
				   (sqr (v[0] * linfun1[i][0] + v[1] * linfun1[i][2] + v[2]*linfun1[i][8])
				    +sqr(v[3] * linfun1[i][4] + v[4] * linfun1[i][6] + v[5]*linfun1[i][9])
				    + sqr(v[0]* linfun1[i][1] + v[3] *  linfun1[i][3] + v[6]*linfun1[i][8])
				    +sqr (v[1]* linfun1[i][5] + v[4] *  linfun1[i][7] + v[7]*linfun1[i][9])
				    )
				   -Interval(0,epseq));
	  ...
	  m_func[i]= new Function (v,(v[0]* (x1.at(i) * x2.at(i) * a1*a1  + x1.at(i) * a1 * a3 + x2.at(i) *a1* a3 + a3*a3 ) 
				      +  v[1] * (x1.at(i)*y2.at(i)*a1*a5 + x1.at(i)* a1* a6 + y2.at(i)*a3*a5 + a3*a6)
				      + v[2]*(x1.at(i) * a1 + a3) 
				      +  v[3]*(x2.at(i) *  y1.at(i) * a1*a5 + x2.at(i)* a1*a6 + y1.at(i) * a3*a5 + a6*a3)
				      +  v[4] * ( y1.at(i) * y2.at(i) * a5*a5 +  y1.at(i) * a5 * a6 + y2.at(i)*a5 * a6 + a6*a6)
				      +  v[5] * ( y1.at(i)* a5 + a6) 
				      +  v[6]* (x2.at(i) *a1+ a3) 
				      +  v[7] * ( y2.at(i)* a5 + a6) 
				      +  v[8]+Interval(-epseq,epseq)));

	  m_fun[0][i]=new Function (v,(-(v[0]* (x1.at(i) * x2.at(i) * a1*a1  + x1.at(i) * a1 * a3 + x2.at(i) *a1* a3 + a3*a3 ) 
				      +  v[1] * (x1.at(i)*y2.at(i)*a1*a5 + x1.at(i)* a1* a6 + y2.at(i)*a3*a5 + a3*a6)
				      + v[2]*(x1.at(i) * a1 + a3) 
				      +  v[3]*(x2.at(i) *  y1.at(i) * a1*a5 + x2.at(i)* a1*a6 + y1.at(i) * a3*a5 + a6*a3)
				      +  v[4] * ( y1.at(i) * y2.at(i) * a5*a5 +  y1.at(i) * a5 * a6 + y2.at(i)*a5 * a6 + a6*a6)
				      +  v[5] * ( y1.at(i)* a5 + a6) 
				      +  v[6]* (x2.at(i) *a1+ a3) 
					 +  v[7] * ( y2.at(i)* a5 + a6)) +Interval(-epseq,epseq)));
	  */
	  /*
	  linfun[i][0][0]=1;
...
//{1.41078e-05, 3.03704e-05, -0.0470103 ,-0.000295304, -2.03532e-06, 0.672895, 0.133288, -0.599274,-9.03183};
	...
	cout << " box1 " << box1 << endl;
	Interval ev = m_func[0]->eval(box1);
	cout << "ev" << ev << endl;
	Function_OG fog(*m_func[0]);
	fog.occurrence_grouping(box1);
        Interval ev1 = fog.eval(box1);
	cout << "evog" << ev1 << endl;
	for (int i=0; i< 9; i++){
