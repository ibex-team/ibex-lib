...
*/	
	...
	*/
	fundmat[0]=-8.654e-07;
	fundmat[1]=0.000300592;
	fundmat[2]=-0.11976;
	fundmat[3]=-0.000145986 ;
	fundmat[4]=3.3916e-06;
	fundmat[5]=0.442058;
	fundmat[6]= 0.0593175 ;
        fundmat[7]=-0.413901;
	fundmat[8]=-11.6557 ;
	...
	*/
	...
	CtcQInterSampson ctcq(9,m_ctc,linfun,epseq,Q);
	...
	CtcQInterSampson ctcq2(9,m_ctc,linfun,epseq,Q);
