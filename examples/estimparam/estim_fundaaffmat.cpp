...
int main(int argc, char** argv) {
	...
	*/
	m_norm = new Function (v, sqrt (sqr(v[0][0])+sqr(v[0][1])+sqr(v[0][2])+ sqr(v[1][0]) + sqr(v[1][1]) + sqr(v[1][2]) + sqr(v[2][0]) + sqr(v[2][1]) +1));
	...
	*/
	...
	//	SolverOptQInter s(ctcqf0,bs,buff,ctcq,2);
